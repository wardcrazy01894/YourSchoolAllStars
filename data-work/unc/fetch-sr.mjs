...
//
// Usage:  node data-work/unc/fetch-sr.mjs [--start 1994] [--end 2025] [--force]
//
...
async function fetchVia(waybackYear, year) {
  const url = `http://web.archive.org/web/${waybackYear}/https://www.sports-reference.com/cfb/schools/north-carolina/${year}.html`
